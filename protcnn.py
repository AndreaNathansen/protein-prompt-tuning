...
if args.window_size is not None:
  results_df.to_csv(args.dataset + f"_protcnn_results_windowsize{args.window_size}_stride{args.window_stride}.csv", index=False)
else:
  results_df.to_csv(args.dataset + f"_protcnn_results_flexible_windowsize_stride{args.window_stride}.csv", index=False)
